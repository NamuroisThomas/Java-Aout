...
public class Volet13 extends JFrame {
	 ...
	 */
	public Volet13() throws FileNotFoundException {
		...
		Story.setText("Vous essayez de vous relevez mais la douleur est intense.");
		...
		btnChoix1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if(lancer.evenementHabilite() == 1) {
						JLabel lblNewLabel = new JLabel();
						lblNewLabel.setText("Vous arrivez à faire abstraction de la douleur et continuer à courir.");
						...
						JLabel lblNewLabel = new JLabel();
						lblNewLabel.setText("La douleur est trop forte et vous retombez au sol.");
						lblNewLabel.setBounds(15, 15, 600, 40);
						Choix.add(lblNewLabel);
