...
public class Volet1 extends JFrame {
	 ...
	 */
	public Volet1() throws FileNotFoundException {
		...
		Story.setText("En vous rendant dans la capitale pour faire votre rapport \r\nsur votre mission pr\u00E9c\u00E9dente.\r\n\r\nVous tombez sur un sac \u00E0 dos dans un foss\u00E9 sur le c\u00F4t\u00E9 du chemin. \r\nVous h\u00E9sitez\u00A0:\r\n\r\nChoix 1: A continuer votre chemin vers la capitale.\r\nChoix 2: A crier pour voir si il y a quelqu\u2019un dans les environs.\r\nChoix 3: A fouiller le sac pour voir ce qu\u2019il y a dedans.");
		...
		btnSauvegarde.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					controleur.sauvegarde(numVolet);
		...
		JButton btnChoix1 = new JButton("Choix 1");
		...
		JButton btnChoix2 = new JButton("Choix 2");
		btnChoix2.setBounds(175, 15, 140, 40);
		Choix.add(btnChoix2);
		...
		JButton btnChoix3 = new JButton("Choix 3");
		btnChoix3.setBounds(335, 15, 140, 40);
		Choix.add(btnChoix3);
