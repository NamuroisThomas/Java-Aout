...
public class Volet2 extends JFrame {
	 ...
	 */
	public Volet2() throws FileNotFoundException {
		...
		Story.setText("Vous continuez votre route vers la capitale. Ce n\u2019est pas vous le h\u00E9ros de cette histoire.\r\n\r\nFin de l\u2019aventure.");
